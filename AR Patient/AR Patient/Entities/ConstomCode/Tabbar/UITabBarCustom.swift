...
class UITabBarCustom: UITabBarController, UITabBarControllerDelegate {
    ...
    func addCustomElements() {
        floatTabAspRatio = scrWidth/CGFloat(320)
    ...
    func addAllElements() {
        lblShadowLine = UILabel(frame: CGRect(x: 0, y: scrHeight - (42 * floatTabAspRatio!), width: scrWidth, height: 1))
    ...
    func generateTabButton(_ intTag: Int, isSelected boolSel: Bool) -> UIButton {
        ...
        let tempY: CGFloat = scrHeight - (42 * floatTabAspRatio!)
        let tempBtnHeight: CGFloat = 42 * floatTabAspRatio!
        let tempBtnWidth: CGFloat = scrWidth / 4
