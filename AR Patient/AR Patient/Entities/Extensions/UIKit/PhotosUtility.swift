...
class PhotosUtility: NSObject,UINavigationControllerDelegate, UIImagePickerControllerDelegate {
    ...
    //Camera Picker
    public typealias openCameraCallBackBlock = (_ selectedImage : UIImage?,_ originalImage : UIImage?) ->Void
        ...
        if !picker.allowsEditing {
            if let img = info[UIImagePickerController.InfoKey.originalImage] as? UIImage {
                if (cameraCallBackBlock != nil){
                    ...
                    cameraCallBackBlock!(img, info[UIImagePickerController.InfoKey.originalImage] as? UIImage)
            ...
            if let img = info[UIImagePickerController.InfoKey.editedImage] as? UIImage{
                if (cameraCallBackBlock != nil){
                    //cameraCallBackBlock!(img)
                    cameraCallBackBlock!(img, info[UIImagePickerController.InfoKey.editedImage] as? UIImage)
                }
            }
        }
