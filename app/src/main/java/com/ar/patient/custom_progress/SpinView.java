...
package com.ar.patient.custom_progress;
...
class SpinView extends AppCompatImageView implements CustomProgress {
    ...
    private void init(Context context) {
        ...
        setColorFilter(ContextCompat.getColor(context, R.color.end_color), android.graphics.PorterDuff.Mode.MULTIPLY);
        mFrameTime = 1000 / 12;
