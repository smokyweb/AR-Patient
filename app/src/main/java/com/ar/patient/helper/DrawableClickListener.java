...
public abstract class DrawableClickListener implements View.OnTouchListener {
     ...
     * {@link com.ar.patient.helper.DrawableClickListener#fuzz}.
     */
    ...
    /**
     * This will create a new instance of a {@link com.ar.patient.helper.DrawableClickListener}
     * object.
     *
     * @param view          The {@link TextView} that this {@link com.ar.patient.helper.DrawableClickListener}
     *                      is associated with.
     * @param drawableIndex The index of the drawable that this
     *                      {@link com.ar.patient.helper.DrawableClickListener} pertains to.
     *                      <br />
    ...
    public DrawableClickListener(final TextView view, final int drawableIndex) {
        this(view, drawableIndex, com.ar.patient.helper.DrawableClickListener.DEFAULT_FUZZ);
    }
     ...
     * drawable.
     */
    public static abstract class LeftDrawableClickListener extends com.ar.patient.helper.DrawableClickListener {
        ...
        public LeftDrawableClickListener(final TextView view) {
            super(view, com.ar.patient.helper.DrawableClickListener.DRAWABLE_INDEX_LEFT);
        }
        ...
        public LeftDrawableClickListener(final TextView view, final int fuzz) {
            super(view, com.ar.patient.helper.DrawableClickListener.DRAWABLE_INDEX_LEFT, fuzz);
        }
     ...
     * drawable.
     */
    public static abstract class TopDrawableClickListener extends com.ar.patient.helper.DrawableClickListener {
        ...
        public TopDrawableClickListener(final TextView view) {
            super(view, com.ar.patient.helper.DrawableClickListener.DRAWABLE_INDEX_TOP);
        }
        ...
        public TopDrawableClickListener(final TextView view, final int fuzz) {
            super(view, com.ar.patient.helper.DrawableClickListener.DRAWABLE_INDEX_TOP, fuzz);
        }
     ...
     * drawable.
     */
    public static abstract class RightDrawableClickListener extends com.ar.patient.helper.DrawableClickListener {
        ...
        public RightDrawableClickListener(final TextView view) {
            super(view, com.ar.patient.helper.DrawableClickListener.DRAWABLE_INDEX_RIGHT);
        }
        ...
        public RightDrawableClickListener(final TextView view, final int fuzz) {
            super(view, com.ar.patient.helper.DrawableClickListener.DRAWABLE_INDEX_RIGHT, fuzz);
        }
     ...
     * drawable.
     */
    public static abstract class BottomDrawableClickListener extends com.ar.patient.helper.DrawableClickListener {
        ...
        public BottomDrawableClickListener(final TextView view) {
            super(view, com.ar.patient.helper.DrawableClickListener.DRAWABLE_INDEX_BOTTOM);
        }
        ...
        public BottomDrawableClickListener(final TextView view, final int fuzz) {
            super(view, com.ar.patient.helper.DrawableClickListener.DRAWABLE_INDEX_BOTTOM, fuzz);
        }
