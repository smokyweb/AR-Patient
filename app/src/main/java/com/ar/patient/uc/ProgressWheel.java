...
public class ProgressWheel extends View {
    ...
    private void parseAttributes(TypedArray a) {
        ...
        textSize = (int) a.getDimension(R.styleable.ProgressWheel_textSize_progress_wheel, textSize);
         ...
         * a.getDimension(R.styleable.ProgressWheel_contourSize, contourSize);
         */
